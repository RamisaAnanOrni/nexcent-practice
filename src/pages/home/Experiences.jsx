    ...
    return (
        <section className='section-container my-24 flex flex-col md:flex-row items-center justify-between md:gap-20 gap-8'>
            ...
            <div className='md:w-1/2 mx-auto'>
                ...
                <h2 className='capitalized text-4xl font-bold mb-4 lg:w-1/2 '> we provide you the best experience</h2>
                <p className='text-secondary dark:text-white mb-5 lg:w-2/3  '>You don’t have to worry about the result 
                    because all of these interiors are made by people who are professionals in their fields with an elegant and 
