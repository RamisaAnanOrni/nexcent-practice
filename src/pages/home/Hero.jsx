...
const Hero = () => {
  return (
    <section className= 'h-screen relative bg-cover bg-center text-white ' 
...
<div className='relative inline-block z-30'> 
   <input placeholder= 'Search furniture' className='w-full md:w-80
   px-6 py-2 bg-white/25 placeholder:text-white rounded-full border
...
{/*bottom blur effect*/}
<div className='absolute inset-x-0 bottom-0 h-3/4 -mb-2 bg-gradient-to-t
 from-white via-transparent to-transparent blur-sm'/>
