...
import materialImg2 from '../../assets/material1.png'
  ...
  return (
    <section className='section-container my-24 flex flex-col md:flex-row items-center justify-between md:gap-20 gap-8'>
            ...
            <div className='md:w-1/2 mx-auto'>
                ...
                <h2 className='capitalized text-4xl font-bold mb-4 lg:w-1/2 '> Very serious materials for making furniture</h2>
                <p className='text-secondary dark:text-white mb-5 lg:w-1/2  '>Because panto was very serious about designing furniture for our environment,
                 using a very expensive and famous capital but at a relatively low price</p>
