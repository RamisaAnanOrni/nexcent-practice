...
<div className='md:col-span-2'>
  ...
  <p className='md:mr-12 '>The advantage of hiring a workspace with us is that givees you 
...
{/*services div */}
      <div>
        ...
        <ul className='space-y-2'>
         <li>
            <Link to="/" className='hover:text-primary'>Email Marketting</Link>
            </li>   
             <li>
        ...
        {/*/copyright */}
        <div className='mt-12 section-container flex flex-com sm:flex-row 
        sm:justify-between sm:items-center sm:text-center gap-4 text-left text-black
         dark:bg-gray-800 dark:text-white border-t border-gray-300 pt-4'>
